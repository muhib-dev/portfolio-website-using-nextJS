    ...
    <div className="md:container md:mx-auto">
      ...
      >
        ...
        <p className="max-w-lg text-[#45526E] leading-8">
          I`&rsquo;m Muhibullah, a web developer and designer who makes websites
          and apps using like, HTML, CSS and Javascript. I really enjoy learning
          new thinks like React, React Native, Vue. I also enjoy wireframing,
          ui, ux, and design in general. My interest in web development started
          back in 2012.
        </p>
      </section>
